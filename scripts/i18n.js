...
const MESSAGES = {
  en: {
    ...
    largeAutoFormatPaused: "Large JSON detected ({size}). Auto-format paused; use Format when ready.",
    largeFileLoaded: "Large file loaded ({size}). Auto-format paused.",
    largeJsonFormatted: "Large JSON formatted and collapsed by default",
    ...
    updatePrompt: "A new JSON Lens version is available.\nCurrent: {current}\nLatest: {latest}\nOpen the release download page?",
    updatePageOpened: "Release download page opened",
  ...
  zh: {
    ...
    largeAutoFormatPaused: "检测到大 JSON（{size}），已暂停自动格式化，请需要时点击格式化。",
    largeFileLoaded: "已加载大文件（{size}），已暂停自动格式化。",
    largeJsonFormatted: "大 JSON 已格式化，并默认折叠全部层级",
    ...
    saved: "已保存到本地",
    scrollSyncEnabled: "已开启同步滚动",
    scrollSyncDisabled: "已关闭同步滚动",
    updateAvailable: "发现新版本 {version}",
    updatePrompt: "JSON Lens 有新版本可用。\n当前版本：{current}\n最新版本：{latest}\n是否打开发布下载页面？",
    updatePageOpened: "已打开发布下载页面",
